...
<html>
    <head>
      ...
      <title>Table des scanners</title>
   	...
   	<div class="row">
   		<div class="col-md-12">
   			<div class="panel panel-info">
   			  <div class="panel-heading"><b>Listes des scanners</b> </div>
                ...
                <tbody>
                    <?php while ($rows = $qs->fetch()): ?>
                        <tr>
                            <td><?php echo htmlspecialchars($rows['nom']) ?></td>
                            <td><?php echo htmlspecialchars($rows['nombredeplacedisponible']); ?></td>
                            <td><?php echo htmlspecialchars($rows['description']); ?></td>
                            <?php
                            $id = htmlspecialchars($rows['id']);
                            $email=htmlspecialchars($rows['nom']);
                            $password=htmlspecialchars($rows['nombredeplacedisponible']);
                            $fullname=htmlspecialchars($rows['description']);
                            ?>
                         <td> <?php echo " <a href='https://cheikhzaid.herokuapp.com/cheikhzaid/admin/php_delete_scanner.php?id=".$id."'>supprimer</a>" ?></td>
                         <td> <?php echo " <a href='https://cheikhzaid.herokuapp.com/cheikhzaid/admin/updateform_scanner.php?id=".$id."'>update</a>" ?></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
