    ...
    -->
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <a class="nav-link active" href="./login_scan.php">
...
<div class="container">
  <form action="php_update_scanners.php" method="post">
  <div class="row">
    <div class="col-25">
      <label for="fname">nom</label>
    </div>
    <div class="col-75">
      <input type="text" id="fname" name="nom" placeholder="le nom.." required>
    </div>
  </div>
  <input type="hidden" id="fname" value=<?php echo $_GET['id']; ?> name="id">
  <div class="row">
    <div class="col-25">
      <label for="fname">nombre de place disponible</label>
    </div>
    <div class="col-75">
      <input type="text" id="fname" name="nombredeplacedisponible" placeholder="nombre de place disponible.." required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
      <label for="fname">datee</label>
    </div>
    <div class="col-75">
      <input type="text" id="fname" name="datee" placeholder="la date.." required>
    </div>
  </div>
    ...
    <div class="col-75">
      <input type="text" id="fname" name="description" placeholder=".." required>
    </div>
  </div>
  <div class="row">
